...
#else
	#define ENTER_PROFILE_SCOPE(name) DE_NOOP()
	#define LEAVE_PROFILE_SCOPE() DE_NOOP()
	#define RECORD_FLOAT(name, value) DE_NOOP()
	#define RECORD_VECTOR3(name, value) DE_NOOP()
	#define ALLOCATE_MEMORY(name, size) DE_NOOP()
	#define DEALLOCATE_MEMORY(name, size) DE_NOOP()
#endif // DAWN_DEBUG
